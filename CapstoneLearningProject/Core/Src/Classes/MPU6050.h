...
#define MPU6050_8BIT_ADDRESS		MPU6050_DEFAULT_ADDRESS << 1
...
#define  MPU6050_ACCEL_AFS_2_SCALE 16384 	// +/- 2g range, AFS_SEL = 0
#define  MPU6050_ACCEL_AFS_4_SCALE 8192 	// +/- 4g range, AFS_SEL = 1
#define  MPU6050_ACCEL_AFS_8_SCALE 4096 	// +/- 8g range, AFS_SEL = 2
#define  MPU6050_ACCEL_AFS_16_SCALE 2048 	// +/- 16g range, AFS_SEL = 3

#define MPU6050_GYRO_FS_SEL_0_SCALE 131 	// +/- 250 deg/s range, FS_SEL = 0
#define MPU6050_GYRO_FS_SEL_1_SCALE 65.5	// +/- 500 deg/s range, FS_SEL = 1
#define MPU6050_GYRO_FS_SEL_2_SCALE 32.8	// +/- 1000 deg/s range, FS_SEL = 2
#define MPU6050_GYRO_FS_SEL_3_SCALE 16.4	// +/- 2000 deg/s range, FS_SEL = 3

#define MPU6050_TEMP_SCALE 340
#define MPU6050_TEMP_OFFSET 159.82
#define MPU6050_CEL_TO_FAR_CONVERSION (9.0/5.0) + 32.0

#define MPU6050_2S_COMPLEMENT_THRESH 0x7FFF
#define MPU6050_2S_COMPLEMENT_CONVERSION 0xF000

#define MPU6050_BUFFER_SIZE 32
#define MPU6050_MAX_TIMEOUT 5000
#define MPU6050_ERROR_CODE 0xFFFF

#define MPU6050_HIGH_REGISTER_OFFSET 8
...
private:
	uint8_t _buf[MPU6050_BUFFER_SIZE] = {};
	uint16_t _val;
